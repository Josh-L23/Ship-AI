...
export function AuthCard() {
  ...
  return (
    <div className="w-full max-w-[880px] min-h-[520px] flex flex-col md:flex-row rounded-2xl overflow-hidden border border-border/50 bg-card/50 backdrop-blur-xl shadow-2xl shadow-black/20">
        ...
        {isLogin ? (
          <>
            <motion.div
              ...
              className="hidden md:flex md:w-[380px] flex-col items-center justify-center p-10 bg-foreground/[0.03] border-r border-border/50"
            >
              <BrandPanel
          ...
          <>
            ...
            <motion.div
              ...
              exit={{ x: "100%", opacity: 0 }}
              transition={{ duration: 0.5, ease: [0.4, 0, 0.2, 1] }}
              className="hidden md:flex md:w-[380px] flex-col items-center justify-center p-10 bg-foreground/[0.03] border-l border-border/50"
            >
              <BrandPanel
